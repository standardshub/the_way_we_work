...
* Participants should read the Project documentation:
  ...
  before attenting to submit an Issue or Pull Request.
...
<figure>
	<img src="images/document-hierarchy.svg" alt="Document Hierarchy">
	<figcaption>Document Hierarchy</figcaption>
</figure>
...
```
<figure>
	<img src="images/specs-lifecycle1.svg" alt="Specifications Life Cycle">
...
<table>
  ...
  <tbody>
    <tr>
	    <td><strong>Work Package</strong></td>
      <td>The Work Package (WP) should describe the scope and expected deliverables and SHALL require WG approval.In this phase the group agrees the scope of the work to be developed.</br>
...
<figure>
	<img src="images/development-stages.svg" alt="Specifications Development Stages">
	<figcaption>Specifications Development Stages</figcaption>
</figure>
